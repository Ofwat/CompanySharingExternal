    ...
    return {        
        ...
        initStyleSwitcher: function() {    
            ...
            var setColor = function (color, data_header) {
                ...
                // }
                // Fixed in v1.9
                jQuery('#style_color').attr("href", "/CompanySharingExternal/css/css-rtl/theme-colors/" + color + ".css");
                if(data_header == 'light'){
                    jQuery('.logo img').attr("src", "/CompanySharingExternal/img/themes/logo1-" + color + ".png");
                    jQuery('#logo-footer').attr("src", "/CompanySharingExternal/img/themes/logo2-" + color + ".png");
                    jQuery('.navbar-brand img').attr("src", "/CompanySharingExternal/img/themes/logo1-" + color + ".png");
                } else if(data_header == 'dark'){
                    jQuery('.logo img').attr("src", "/CompanySharingExternal/img/themes/logo1-" + color + ".png");
                    jQuery('#logo-footer').attr("src", "/CompanySharingExternal/img/themes/logo2-" + color + ".png");
                }
